...
from .views import StoreViewSet,ProductViewSet,ProductCapacityViewSet
...
urlpatterns = [
    ...
    path("<uuid:store_uuid>/products",ProductViewSet.as_view({"get":"retrieve", "post":"create"}),name='listproducts'),
