...
urlpatterns = [
    path('material',MaterialViewSet.as_view({"get":"retrieve","post":"create"}),name='listmaterial'),
    ...
    path("<uuid:store_uuid>/material/stock/<uuid:material_stock_uuid>/restock",MaterialRestockViewSet.as_view({"get":"retrieve","post":"create"}),name='materialrestock'),
